...
export const PLATFORM_CAPABILITIES = [
  ...
  { id: "local-ocr",       label: "On-device text recognition", module: "local-text-detect.js",
    consumers: ["article scan (on-device)"], status: "emerging",
    description: "Optional on-device OCR via the browser TextDetector (Chromium/Android; absent on iOS Safari/Firefox) — raw text, no layout model, so an OFFLINE/fast path for clean printed pages (articles), never a receipt-grade extractor. Cloud vision stays the accurate default; a native VisionKit/ML-Kit shell could fill the same slot later." },
